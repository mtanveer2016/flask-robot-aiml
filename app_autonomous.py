...
if __name__ == "__main__":
    print("=" * 60)
    print("🤖 Autonomous Robot Car System with Enhanced Ball Following")
    print("=" * 60)
    print("Access URLs:")
    ...
    print("  ⚽ Ball Following - Track and follow orange ball (IMPROVED!)")
    print("  📍 Waypoint Navigation - Follow predefined path")
    print("  🚓 Patrol Mission - Autonomous patrol route")
    ...
    print(f"  💡 LED: OK")
    print("=" * 60)
    print("\n💡 TIP: If ball following is not smooth, visit /calibrate to tune settings!")
    print("=" * 60)
